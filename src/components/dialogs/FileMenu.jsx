...
//import { sendAttachment } from '../../../../server/controllers/chat';
...
const FileMenu = ({anchorE1,chatId}) => {
  ...
  const selectAudio = () => audioeRef.current?.click();
  ...
  return (
    <Menu anchorEl={anchorE1} open={isFileMenu} onClose={closeFile} >
        <div style={{
          width:"10rem"
        }}>
          <MenuList>
